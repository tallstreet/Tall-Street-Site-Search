...
@register.filter
def display_endorsements(endorsements):
	"Display endorsements"
	return ', '.join( ["<a href=http://searchter.com/%s/>%s</a>" % (endorsement, endorsement) for endorsement in endorsements] )

@register.filter
def endorsed(endorsements):
	"Display endorsements"
	return ', '.join( ["<a href=http://searchter.com/%s/>%s</a>" % (endorsement, endorsement) for endorsement in endorsements] )
